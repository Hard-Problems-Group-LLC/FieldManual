# AmazingDNSHammer Requests In Progress

Store acknowledged or actively handled AmazingDNSHammer ECRs here. Keep
`Source lifecycle: In Progress`, preserve the submitted request text, and
append the authoritative AmazingDNSHammer handling reference.
